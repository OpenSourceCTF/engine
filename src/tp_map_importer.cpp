...
int tp_map_importer::tp_import_png(const std::string & src)
{
    ...
    for(std::size_t i=0; i<pixels.size() / 4; ++i) {
        ...
        if(tiletype == tp_tile_type::background) {
            ...
            m.walls.emplace_back(new wall(polygon(x-0.5f, y-0.5f,
                                                  x+0.5f, y-0.5f,
                                                  x-0.5f, y+1),
                                                  config.COLOR_WALL));
            m.tiles.emplace_back(new tile(polygon(x+0.5f, y-0.5f,
                                                  x+0.5f, y+0.5f,
                                                  x-0.5f, y+0.5f),
                                                  config.COLOR_TILE,
                                                  tile_type::normal));
            ...
            m.walls.emplace_back(new wall(polygon(x+0.5f, y-0.5f,
                                                  ...
                                                  x-0.5f, y+0.5f),
                                                  config.COLOR_WALL));
            m.tiles.emplace_back(new tile(polygon(x-0.5f, y-0.5f, x+0.5f,
                                                  y-0.5f, x-0.5f,
                                                  y+0.5f), config.
                                                  COLOR_TILE,
                                                  tile_type::normal));
